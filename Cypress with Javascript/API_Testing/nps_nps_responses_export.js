...
describe('NPS', function() {
    ...
    it('Export NPS Responses with valid data', function() {   
        cy.request ({
            method:'GET',
            url: `${api_url}s/${shop_unique}/nps/export/responses.csv`,
            headers: {
    ...
    it('Export NPS Responses with invalid data', function() {   
        cy.request ({
            method:'GET',
            url: `${api_url}s/${shop_unique}/nps/export/`,
