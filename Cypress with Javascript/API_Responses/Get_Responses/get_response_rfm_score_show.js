...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for rfm score show', function() {
        cy.request({
            method: 'GET',
            url: `${api_url}s/${shop_unique}/rfm-scores/122`,
            ...
            const fileName = `response_rfm_score_show_${shop_unique}_${platform}.json`
