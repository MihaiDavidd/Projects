...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings email provider sendgrid show', function() {
        cy.request({
            method: 'GET',
            url: `${api_url}s/${shop_unique}/settings/email_provider/sendgrid`,
            ...
            const fileName = `response_settings_email_provider_sendgrid_show_${shop_unique}_${platform}.json`
