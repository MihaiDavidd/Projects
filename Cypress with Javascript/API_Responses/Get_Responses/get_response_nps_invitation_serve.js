...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for nps invitation serve', function() {
        cy.request({
            method: 'GET',
            url: `${api_url}nps-invitations/${api_serve_id}/serve`,
            ...
            const fileName = `response_nps_invitation_serve_${shop_unique}_${platform}.json`
