...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings nps sendgrid show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_settings_nps_sendgrid_show_${shop_unique}_${platform}.json`
