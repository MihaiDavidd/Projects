...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings order status map show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_settings_order_status_map_show_${shop_unique}_${platform}.json`
