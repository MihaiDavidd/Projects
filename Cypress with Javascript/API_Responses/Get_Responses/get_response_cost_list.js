...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for cost list', function() {
        cy.request({
            method: 'GET',
            url: `${api_url}s/${shop_unique}/costs`,
            ...
            const fileName = `response_cost_list_${shop_unique}_${platform}.json`
