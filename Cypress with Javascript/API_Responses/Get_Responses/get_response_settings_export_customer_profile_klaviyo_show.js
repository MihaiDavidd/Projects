...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings export customer profile klaviyo show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_settings_export_customer_profile_klaviyo_show_${shop_unique}_${platform}.json`
