...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings customer events show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_settings_customer_events_show_${shop_unique}_${platform}.json`
