...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for integration explore show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_integration_explore_show_${shop_unique}_${platform}.json`
