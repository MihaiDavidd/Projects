...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for customer attributes show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_customer_attributes_show_${shop_unique}_${platform}.json`
