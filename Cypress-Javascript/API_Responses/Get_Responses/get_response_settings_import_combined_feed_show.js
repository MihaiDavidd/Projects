...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings import combined feed show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_settings_import_combined_feed_show_${shop_unique}_${platform}.json`
