...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for settings nps klaviyo show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_settings_nps_klaviyo_show_${shop_unique}_${platform}.json`
