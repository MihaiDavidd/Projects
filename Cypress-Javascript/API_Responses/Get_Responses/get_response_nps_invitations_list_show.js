...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for nps invitations list show', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_nps_invitations_list_show_${shop_unique}_${platform}.json`
