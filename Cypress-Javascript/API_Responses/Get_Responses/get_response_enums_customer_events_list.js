...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for enums customer events list', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_enums_customer_events_list_${shop_unique}_${platform}.json`
