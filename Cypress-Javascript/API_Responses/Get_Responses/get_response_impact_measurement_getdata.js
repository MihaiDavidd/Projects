...
describe('API Response', function() {
    ...
    it('Append response body to JSON file for impact measurement getdata', function() {
        cy.request({
            method: 'GET',
            ...
            const fileName = `response_impact_measurement_getdata_${shop_unique}_${platform}.json`
